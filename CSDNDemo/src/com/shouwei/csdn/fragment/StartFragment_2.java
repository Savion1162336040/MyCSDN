...
public class StartFragment_2 extends Fragment {
    ...
    public StartFragment_2(Activity mActivity) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = LayoutInflater.from(mActivity).inflate(R.layout.fragment_2,null);
        init();
        return view;
    }
    private void init(){
        ...
        iv1 = (ImageView) view.findViewById(R.id.fragment2_iv1);
